...
void LiFi_Modem_Fixture_Init(LiFi_Modem_Fixture_t *fixture) {
  ...
  Fake_LiFi_Link_Register(&fixture->modem_socket_storage.transmitter, &fixture->peer.receiver);
  Fake_LiFi_Link_Register(&fixture->peer.transmitter, &fixture->modem_socket_storage.receiver);
  ...
  LiFi_Modem_Init(&fixture->modem, &fixture->host_interface, &fixture->modem_socket_storage.socket);
}
